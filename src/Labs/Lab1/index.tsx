      ...
      <div id="wd-lab1">
        ...
        <div id="wd-lists">
          ...
          <ol id="wd-your-favorite-recipe">
            <li>Wash and cut the broccoli into small florets, then blanch them in boiling water for 1 minute and drain.</li>
            <li>Heat oil in a pan, add sliced garlic, and stir-fry until fragrant.</li>
            <li>Add the broccoli and stir-fry for about 2 minutes.</li>
            <li>Season with salt and a pinch of chicken bouillon (optional).enjoy!</li>
            </ol>
        </div>
        ...
        <div id="wd-anchor">   
          ...
          Please
          <a id="wd-github" href="https://github.com/YanqiongMa/kanbas-react-web-app.git">click here</a>
          to GitHub<br/>    
        </div>
      </div>
    );
